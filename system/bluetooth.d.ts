...
declare module '@system.bluetooth' {
   ...
   * 监听蓝牙适配器状态变化事件
   */
  let onadapterstatechange: (data: AdapterState) => void;
   ...
   * 监听寻找到新设备的事件
   */
  let ondevicefound: (data: OnDeviceFoundOptions) => void;
   ...
   */
  let onblecharacteristicvaluechange: (data: OnBLECharacteristicvalueChangeOptions) => void;
   ...
   */
  let onbleconnectionstatechange: (data: OnBLEConnectionStateChange) => void;
}
